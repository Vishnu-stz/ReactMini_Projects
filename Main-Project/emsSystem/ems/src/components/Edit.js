                    ...
                    <div class="row t d d-flex py-2 justify-content-center align-items-center h-100">
                        ...
                        <div class="container col t d col-xl-10 bg-transparent mt-5 mb-5">
                                ...
                                <div class="container g-0 bg-transparent mt-3 mb-3">
                                    ...
                                    <div className=''>
                                        <h3 className=''> Edit Employee Details </h3>
                                    </div>
                                    ...
                                    <img src='https://mdbootstrap.com/img/new/avatars/8.jpg' alt=''  style={{ width: '120px', height: '120px' }} className='rounded-circle fI mb-3 mt-3 p-2' />
                                        ...
                                        <MDBRow className='mb-4'>
                                            <MDBCol>
                                                <label className="form-label mt-1"> Edit File  </label>
                                            ...
                                            <MDBCol>
                                                ...
                                                <div className="btn-group dr mb-2 mt-2">
                                                    ...
                                                    <select class="form-select" className='Dro2' aria-label="Default select example">
                                                        ...
                                                        <option value="" className='dropdown-item disabled text-center' aria-disabled= "true"> Employee Status </option>
                                                        <option value=""> <li className='container' > <a className="dropdown-item rounded-5 w-100 dd mt-1" href="#/"> Active <i class="fa-regular fa-thumbs-up fa-shake ms-1" style={{color: "#4edfdf"}} ></i> </a></li> </option>
                                                        <option value=""> <li className='container'> <a className="dropdown-item rounded-5 w-100 dd mt-3" href="#/"> inActive <i class="fa-regular fa-thumbs-down fa-bounce ms-1" style={{color: "#4edfdf"}} ></i> </a> </li> </option>
                                        ...
                                        <MDBBtn outline color="light" floating className='mb-3 i d' href='#!' role='button'>
                                            <i className="fa-solid fa-hourglass-start fa-spin me-1"> </i> Update Details
                                        </MDBBtn>
